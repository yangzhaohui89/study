...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" placeholder="@" value="${admin.email}" name="email" id="email" datatype="e" nullmsg="请输入邮箱！">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5" id = "roles"> 
				<c:forEach items="${roles}" var="role">
					<label><input type="checkbox" value="${role.id}" name="roles">${role.name}&nbsp;&nbsp;</label>
				</c:forEach>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript" src="lib/form/jquery.form.js"></script> 
